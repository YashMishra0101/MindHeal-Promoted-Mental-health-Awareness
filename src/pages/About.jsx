...
const AboutUs = () => {
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl md:text-4xl font-bold text-green-600 mb-6 text-center">About Us</h1>
      <div className="flex flex-col md:flex-row items-center justify-center">
        ...
        <div className="md:w-1/2 md:ml-6">
          <p className="text-gray-700 mb-4">
            At Mindmate, our mission is to provide a safe and supportive environment for individuals struggling with mental health challenges. We understand that seeking help can be difficult, which is why we've created a platform where you can find resources, connect with others, and access professional support.
          </p>
          <p className="text-gray-700 mb-4">
